...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen m-auto flex justify-center gap-10 w-9/12 items-center">
       <div className="w-1/2 h-full  flex flex-col gap-5">
        ...
        <p className="w-9/12 text-sm text-violet-700">
          Organiza todos los clientes de tu empresa en un solo lugar
        </p>
      </div>
      <div className="bg-gray-800 text-white p-8 rounded shadow-md w-1/2">
